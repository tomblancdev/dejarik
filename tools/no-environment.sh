...
dep='(([a-z0-9-]+\.)*(example\.(com|net|org)|github\.com|githubusercontent\.com|google\.com|ghcr\.io|docker\.io|golang\.org|go\.dev|gopkg\.in|w3\.org|opensource\.org|flathub\.org|freedesktop\.org|kernel\.org|ietf\.org|rfc-editor\.org|schema\.org|openapis\.org|htmx\.org|alpinelinux\.org|spotify\.com)|[a-z0-9-]+\.example|localhost)'
